...
import com.fadlan.airquality.databinding.ActivityListViewHomeBinding

class ListViewHome : AppCompatActivity() {

    private lateinit var binding: ActivityListViewHomeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityListViewHomeBinding.inflate(layoutInflater)
        ...
        listAdapter = ListAdapter(this@ListViewHome, dataArrayList)
        binding.listview.adapter = listAdapter
        binding.listview.isClickable = true
        binding.listview.onItemClickListener = OnItemClickListener { adapterView, view, i, l ->
            val intent = Intent(this@ListViewHome, DetailedActivity::class.java)
